...
public class TopAppsUtil {
    public static class TopAppsSAXParser extends DefaultHandler{
        ...
        public static ArrayList<TopPods> parseTopApps(InputStream inputStream){
        ...
        public ArrayList<TopPods> getTopappslist() {
            return topappslist;
        }
        ...
        public void startDocument() throws SAXException {
            super.startDocument();
            topappslist=new ArrayList<TopPods>();
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            ...
            if(qName.equals("im:name")) {
                topapp.setTittle(attributes.getValue("label"));
                Log.d("demo", "" + topapp.getTittle());
            }
...
//                topapp.setCategory(attributes.getValue("label"));
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            ...
            if (localName.equals(("entry"))) {
                ...
                Log.d("values", "_________________________________________________________ "+topapp.getTittle());
